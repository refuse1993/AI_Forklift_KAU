...
public class PutObject : GoapAction
{
    ...
    public PutObject()
    {
        addPrecondition("isObject", true); // if we have ore we don't want more
        //addEffect("isObject", false);
    ...
    public override bool perform(GameObject agent)
    {
        ...
        if (fork.transform.position.y <= 0 ) arrived = true;
